"""
Cart-Pole Balance Environment v11
- Curriculum Learning: Start with easy task, gradually increase difficulty
- Termination angle starts at 15 degrees, gradually increases to 45 degrees
- Learning rate schedule integrated
"""
...
class CartPoleEnvV11(MujocoEnv, utils.EzPickle):
    ...
    def step(self, action):
        # Scale action from [-1, 1] to [-2.4, 2.4]
        action_scale = 2.4
