"""
Test v4 model from first run (10:32)
"""
import numpy as np
from stable_baselines3 import PPO
from cart_pole_env_v4 import CartPoleEnvV4

model_path = "saved_models/PPO_CartPole_v4_20260526_1032_2000000/best_model.zip"

print("Testing v4 model from 10:32 (first run)...")
